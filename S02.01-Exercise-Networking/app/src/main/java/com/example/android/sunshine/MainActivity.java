...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        new SunshineWeatherTask().execute(location);
    }

    // TODO (5) Create a class that extends AsyncTask to perform network requests

    public class SunshineWeatherTask extends AsyncTask<String, Void, String[]>
    {
        @Override
        protected String[] doInBackground(String... strings) {
            ...
            URL weatherReqUrl = NetworkUtils.buildUrl(location);

            try {
                String jsonWeatherResp = NetworkUtils
                        .getResponseFromHttpUrl(weatherReqUrl);

                String[] jsonWeatherData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherResp);
