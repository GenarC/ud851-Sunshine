...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String location = sp.getString(context.getString(R.string.pref_location_key),context.getString(R.string.pref_location_default));
        /** This will be implemented in a future lesson **/
        return location;
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        String result = sp.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        /** This will be implemented in a future lesson **/
        return result.equals("metric");
    }
