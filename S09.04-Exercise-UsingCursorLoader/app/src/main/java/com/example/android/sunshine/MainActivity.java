...
//  TODO (17) Create constant int values representing each column name's position above
    public static final int dateInd = 0;
    public static final int maxInd = 1;
    public static final int minInd = 2;
    public static final int weatherIdInd = 3;
...
//          TODO (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        ...
        switch (id){
            case ID_FORECAST_LOADER:
                ...
                String slc = WeatherContract.WeatherEntry.getSqlSelectForTodayOnwards();
