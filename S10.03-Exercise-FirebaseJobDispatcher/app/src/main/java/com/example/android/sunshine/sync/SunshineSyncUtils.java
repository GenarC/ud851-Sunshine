...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int SECONDS = (int) TimeUnit.HOURS.toSeconds(HOURS);
    private static final int FLEX_SECONDS = SECONDS / 3;


    private static boolean sInitialized;

//  TODO (11) Add a sync tag to identify our sync job
    private static final String SYNC_TAG = "SYNC-SUNSHINE";

//  TODO (12) Create a method to schedule our periodic weather sync
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context c) {

        Driver driver = new GooglePlayDriver(c);
