...
//  TODO (1) Create a constant int value to identify the notification
    private static final int NOTF_ID = 1567;
...
//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            ...
            tStackBuilder.addNextIntentWithParentStack(detailIntent);
            PendingIntent pendingIntent =tStackBuilder.getPendingIntent(
                            0,
...
//          TODO (6) Get a reference to the NotificationManager
            NotificationManager notfMang = (NotificationManager)
                    context.getSystemService(Context.NOTIFICATION_SERVICE);

//          TODO (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            notfMang.notify(NOTF_ID, notificationBuilder.build());
